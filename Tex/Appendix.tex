...
\section{测试公式编号 \texorpdfstring{$\Lambda,\lambda,\theta,\bar{\Lambda},\sqrt{S_{NN}}$}{}} \label{sec:testmath}
...
mathtext: $A,F,L,2,3,5,\sigma$, symup: $\symup{A,F,L,2,3,5,\sigma}$, symbf: $\symbf{A,F,L,2,3,5,\sigma}$.

symbfup: $\symbfup{A,F,L,2,3,5,\sigma}$, symit: $\symit{A,F,L,2,3,5,\sigma}$, symsf: $\symsf{A,F,L,2,3,5,\sigma}$.

symtt: $\symtt{A,F,L,2,3,5,\sigma}$, symfrak: $\symfrak{A,F,L,2,3,5,\sigma}$, symbb: $\symbb{A,F,L,2,3,5,\sigma}$.

symcal: $\symcal{A,F,L,2,3,5,\sigma}$, symscr: $\symscr{A,F,L,2,3,5,\sigma}$, symbfit: $\symbfit{A,F,L,2,3,5,\sigma}$.

boldsymbol: $\boldsymbol{A,F,L,2,3,5,\sigma}$.
